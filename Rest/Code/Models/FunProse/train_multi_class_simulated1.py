...
from Code.Models.CNNs.funprose_adapted_multi_class_len1000 import get_funprose
...
# Load data
df = pd.read_csv('Data/Processed/simulated3_90000_1000_no_interaction_non_orthogonal.csv')
...
train(
    ...
    "sim3_90000_1000_no_interaction_non_orthogonal",
    300,
    512,
