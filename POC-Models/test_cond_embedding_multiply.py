...
if _6mer:
    ...
    model_names = [f'BigFilterMaxPoolCondEmbeddingMultiply_6merMotifs_{i}' for i in range(5)]
    Base_model_name = 'BigFilterMaxPoolCondEmbeddingMultiply_6merMotifs'
else:
    motifs = ["TTCCCTCG", "CTACCTCC", "TGCAGTGC"]
    model_names = [f'BigFilterMaxPoolCondEmbeddingMultiply_{i}' for i in range(5)]
    Base_model_name = 'BigFilterMaxPoolCondEmbeddingMultiply'
